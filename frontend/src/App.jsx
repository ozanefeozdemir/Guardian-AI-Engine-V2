            ...
            isAuthenticated ? (
              <div className="relative">
                ...
                <button 
                  ...
                  className="fixed top-4 right-4 z-[9999] bg-red-600/80 hover:bg-red-500 text-white px-4 py-2 rounded-lg font-bold text-sm backdrop-blur border border-red-500/50 transition-all"
                >
                  Çıkış Yap
                </button>
